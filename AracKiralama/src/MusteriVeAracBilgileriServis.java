...
import java.util.Scanner;
    ...
    public class MusteriVeAracBilgileriServis {
        ...
        public static AracTalebi aracTalep() {
            ...
            do {
                isValid = false;
                System.out.println("Araci teslim almak istediginiz tarihi(gun/ay/yil) seklinde  belirtiniz : ");
                dateOfTake = LocalDate.parse(inp.nextLine(), DateTimeFormatter.ofPattern("dd/MM/yyyy"));
                System.out.println("Araci teslim etmek istediginiz tarihi(gun/ay/yil) seklinde belirtiniz : ");
                dateOfDelivery = LocalDate.parse(inp.nextLine(), DateTimeFormatter.ofPattern("dd/MM/yyyy"));
                System.out.println("Araci teslim etmek istediginiz saati(saat:dakika) seklinde belirtiniz : ");
        ...
        public static void getAraba() {
            ...
            if (secim.equals("1")) {
                ...
                getAraba();
            } else System.out.println("İyi Günler Diler Yine Bekleriz");
